...
class WebScraper:
    ...
    def read_data(self):
        ...
        for radio in self.child_radio_list:
            ...
            read_up_snr_column(self.driver, radio, radio_count)
            read_up_tx_column(self.driver, radio, radio_count)
            read_up_rx_column(self.driver, radio, radio_count)
            read_link_time_column(self.driver, radio, radio_count)

            # Read Down Link table Data
            read_down_snr_column(self.driver, radio, radio_count)
            read_down_location_column(self.driver, radio, radio_count)
            read_down_pwr_column(self.driver, radio, radio_count)
            read_down_rx_column(self.driver, radio, radio_count)
            read_down_temp_column(self.driver, radio, radio_count)
            read_ear_time_column(self.driver, radio, radio_count)
            read_down_tx_column(self.driver, radio, radio_count)
